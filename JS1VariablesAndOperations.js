...
var streetAddress = '3953 W Division St'
...
//  ↓ YOUR CODE HERE ↓
console.log('Your total is' + (costOfGroceries + 2.15))

    console.log('Fix a Birth Certificate:')
//	A birth certificate was printed incorrectly, change the middle initial to something else
//  ↓ YOUR CODE HERE ↓
middleInitial = 'A'
console.log('Middle Initial has changed to' + middleInitial)

    console.log('Changing Seasons:')
//	The season has changed, update the hot outside variable	to be opposite of what it was
//  ↓ YOUR CODE HERE ↓
    isHotOutside = false
    console.log("It's no longer Summer, Fall has come!")

    console.log('Full Name:')
//	Create a new variable called full name using the customer's
//  first name, the middle initial, and a last name of your choice
//  ↓ YOUR CODE HERE ↓
var fullName = firstName + " " + middleInitial + " " + "Evans"
...
//  ↓ YOUR CODE HERE ↓
console.log("This is our new customer! Their name is: " + fullName + '.' + fullName + 'and they live at' + streetAddress)
